...
public class ClanServiceImpl implements ClanService{
    ...
    private ClanMemberContributionRepository clanMemberContributionRepository;
    private UserRepository userRepository;
    private ModelMapper modelMapper;

    @Autowired
    public ClanServiceImpl(ClanRepository clanRepository, ClanMembersRepository clanMembersRepository,
                           ClanMemberContributionRepository clanMemberContributionRepository, UserRepository userRepository,
                           ModelMapper modelMapper) {
        this.clanRepository = clanRepository;
        this.clanMembersRepository = clanMembersRepository;
        this.clanMemberContributionRepository = clanMemberContributionRepository;
    ...
    @Override
    public void addPointsToClan(int clanId, UUID userId, int points) {

    }

    @Override
    public void updateClanLeague(int clanId) {

    }

    @Override
    public List<ClanMemberDTO> getClanMembers(int clanId) {
        return List.of();
    }

    @Override
    public List<ClanDTO> searchClans(String name) {
        return List.of();
    }

    @Override
    public List<ClanDTO> getTopClans() {
        return List.of();
    }

    @Override
    public List<ClanMemberContributionDTO> getMemberContributions(int clanId) {
        return List.of();
    }
}
