...
public class WorkoutRestController {
    ...
    public ResponseEntity<Map<String,List<WorkoutDTO>>> findByUserId(@PathVariable int userId){
    ...
    public ResponseEntity<WorkoutDTO> newWorkout(@RequestBody WorkoutDTO workoutJSON, @PathVariable int userId){
        return ResponseEntity.ok(workoutService.save(workoutJSON, userId));
    }

    @PutMapping("/workout/{userId}")
    public WorkoutDTO updateWorkout(@RequestBody WorkoutDTO workoutDTO, @PathVariable int userId){
